...
export const MOCK_HEALTH_LOGS: PetHealthLog[] = [
  {
    ...
    notes: "Khám định kỳ: Bé tăng cân đều đặn, niêm mạc hồng hào, phản xạ nhanh nhạy.",
  ...
  },
  {
    ...
    stool_condition: "normal",
    vomiting: false,
    notes: "Ăn uống bình thường, vui vẻ chạy nhảy trong công viên",
  ...
  },
  {
    ...
    appetite: "decreased",
    activity_level: "low",
    stool_condition: "soft",
    vomiting: false,
    symptoms: "Hơi uể oải, ăn ít hơn nửa khẩu phần thường ngày",
    notes: "Bác sĩ kiểm tra: Răng nướu bình thường, theo dõi chế độ dinh dưỡng thêm men tiêu hóa.",
    created_at: "2025-08-10T14:15:00Z",
    updated_at: "2025-08-10T14:15:00Z",
  },
  {
    id: "hl4",
    pet_id: "p1",
    ...
    stool_condition: "normal",
    vomiting: false,
    notes: "Đo cân nặng tại nhà sau đợt tẩy giun",
  ...
  },
  {
    ...
    stool_condition: "normal",
    vomiting: false,
    symptoms: "Sức khỏe ổn định",
    notes: "Bác sĩ kiểm tra sau tiêm mũi nhắc lại: Vết tiêm khô ráo, không sốt phản ứng.",
  ...
  },
  {
    ...
    stool_condition: "normal",
    vomiting: false,
    notes: "Bé rất ham ăn, đổi sang hạt royal canin kitten hợp khẩu vị",
...
export const MOCK_PAYMENTS: Payment[] = [
  {
    ...
    status: "pending",
    transaction_ref: "VCB-984721",
    payment_date: "2026-09-21T08:30:00Z",
  ...
  },
  {
    ...
    payment_method: "cash",
    status: "pending",
    payment_date: "2026-09-21T09:15:00Z",
  ...
  },
  {
    ...
    payment_date: "2025-07-10T11:30:00Z",
  ...
  },
  {
    ...
    payment_date: "2026-09-19T23:50:46Z",
  ...
  },
  {
    ...
    payment_method: "bank_transfer",
    status: "failed",
    reject_reason: "Nội dung chuyển khoản không trùng khớp với mã hóa đơn và chưa nhận được tiền.",
    transaction_ref: "MB-888888",
    payment_date: "2026-09-20T01:01:40Z",
