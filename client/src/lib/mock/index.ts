...
export const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    message: "Mochi cần tiêm nhắc lại Vaccine Dại định kỳ hàng năm.",
    content: "Mochi cần tiêm nhắc lại Vaccine Dại định kỳ hàng năm.",
    is_read: false,
    pet_id: "p1",
    pet_name: "Mochi",
    pet_species: "dog",
  ...
  },
  {
    ...
    message: "Bạn có lịch hẹn khám định kỳ cho Mochi vào ngày mai lúc 10:00.",
    content: "Bạn có lịch hẹn khám định kỳ cho Mochi vào ngày mai lúc 10:00.",
    is_read: false,
    pet_id: "p1",
    pet_name: "Mochi",
    pet_species: "dog",
  ...
  },
  {
    ...
    title: "Lịch tái khám theo dõi sức khỏe cho Mochi",
    message: "Đến hẹn kiểm tra vết mổ và đánh giá tốc độ hồi phục sau điều trị.",
    content: "Đến hẹn kiểm tra vết mổ và đánh giá tốc độ hồi phục sau điều trị.",
    is_read: false,
    pet_id: "p1",
    pet_name: "Mochi",
    pet_species: "dog",
  ...
  },
  {
    ...
    user_id: "u1",
    type: "appointment_reminder",
    title: "Lịch hẹn siêu âm ổ bụng cho Mochi",
    message: "Nhắc bạn về lịch siêu âm định kỳ cho Mochi đã được đặt trước.",
    content: "Nhắc bạn về lịch siêu âm định kỳ cho Mochi đã được đặt trước.",
    is_read: true,
    pet_id: "p1",
    pet_name: "Mochi",
    pet_species: "dog",
